...
float32_t our_arm_cos_f32(
  float32_t x)
{
  float32_t cosVal = 0.0f;
  float32_t fract = 0.0f;
  float32_t in = 0.0f;                   /* Temporary variables for input, output */
  uint16_t index = 0;                                /* Index variable */
  float32_t a = 0.0f;
  float32_t b = 0.0f;                                /* Two nearest output values */
  int32_t n = 0;
  float32_t findex = 0.0f;
