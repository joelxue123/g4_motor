...
function(CMSIS_CrossCompilingConfiguration)
    set(STARTUP_FILE "Startup/ArmClang/*.*" CACHE STRING "global")
    #设置变量
    ...
    #设置C编译器选项
    set(CMAKE_C_FLAGS_INIT " ${C_TARGET_FLAG} ${COMPILE_RULE_FLAG} -fno-rtti -c -ffunction-sections -w" CACHE STRING "global")
